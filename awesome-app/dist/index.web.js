...
Component.options.__file = "/Users/witgo/awesome-app/src/index.vue"
...
var update = __webpack_require__(7)("46daa211", content, false);
...
exports.default = {
  ...
  methods: {
    jump: function jump() {
      var path = weex.config.bundleUrl.split('index.js')[0];
      console.log(path);
      weex.requireModule('navigator').push({
        url: path + 'index-two.js',
        animated: 'true'
      });
    }
  }
